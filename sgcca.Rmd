...
## 2. Choose the penalization values with highest AVE and lowest nfeatures
...
## 3. Run an SGCCA per subtype, using the adjuted penalization values
...
## 4. Run with 100 subsets of the data to check the stability
...
## 5. Count the features selected for the subsets to check the stability
